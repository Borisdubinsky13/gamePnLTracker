...
public class DisplayQueryData extends Activity 
{
	...
	protected void onResume() 
	{
        ...
        ArrayAdapter<CharSequence> evType = ArrayAdapter.createFromResource(
                this, R.array.evTypeSearch, android.R.layout.simple_spinner_item);
        ...
        StartDateB.setOnClickListener(new View.OnClickListener()
        {
        	public void onClick(View v) 
        	{
        		...
        		new DatePickerDialog(DisplayQueryData.this, mStartDateSetListener, mYear, mMonth-1, mDay).show();
        	}
        });
        ...
        EndDateB.setOnClickListener(new View.OnClickListener()
        {
        	public void onClick(View v) 
        	{
        		...
        		new DatePickerDialog(DisplayQueryData.this, mEndDateSetListener, mYear, mMonth-1, mDay).show();
         	}
        });
